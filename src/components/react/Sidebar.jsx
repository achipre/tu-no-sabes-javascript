...
export const Sidebar = ({direction}) => {
	...
	<aside className={`fixed top-0 left-0 ${isOpen ? "-translate-x-80" :"translate-x-0"} z-40 w-96  h-screen transition-transform`} ariaabel="Sidenav">
		
		<div className="overflow-y-auto py-5 px-3 h-full bg-[#f6e4c5] dark:bg-amber-900">
			<ul className="space-y-2">
				<li className="list-none flex gap-2">
					<a href="/javascript-la-guia-definitiva" className="group flex flex-1 items-center p-2 text-lg font-bold text-amber-900 rounded-sm dark:text-white dark:hover:bg-[#FFF8E8] transition-colors duration-500 dark:hover:text-amber-900 hover:text-[#FFF8E8] hover:bg-amber-900">
						<svg version="1.1" x="0px" y="0px" className="w-6 h-6 transition duration-500 group-hover:fill-amber-900 fill-[#FFF8E8]" viewBox="0 0 64 64"  width="64" height="64">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-2" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-2' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">2. Estructura léxica</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-2' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<ul id="dropdown-pages" className="hidden py-2 space-y-2">
						<li>
							<a href="#" className="group flex items-center p-2 pl-11 w-full text-base font-normal text-amber-900 rounded-sm group dark:text-white dark:hover:bg-[#FFF8E8] transition-colors duration-500 dark:hover:text-amber-900 hover:text-[#FFF8E8] hover:bg-amber-900">Settings</a>
						</li>
						<li>
							<a href="#" className="group flex items-center p-2 pl-11 w-full text-base font-normal text-amber-900 rounded-sm group dark:text-white dark:hover:bg-[#FFF8E8] transition-colors duration-500 dark:hover:text-amber-900 hover:text-[#FFF8E8] hover:bg-amber-900">Kanban</a>
						</li>
						<li>
							<a href="#" className="group flex items-center p-2 pl-11 w-full text-base font-normal text-amber-900 rounded-sm group dark:text-white dark:hover:bg-[#FFF8E8] transition-colors duration-500 dark:hover:text-amber-900 hover:text-[#FFF8E8] hover:bg-amber-900">Calendar</a>
						</li>
					</ul>
				</li>
				<li className="list-none">
						<a href="/javascript-la-guia-definitiva/capitulo-3" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-3' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
							<span className="ml-3 flex-1">3. Tipos, valores y variables</span>
							{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-3' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-4" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-4' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">4. Expresiones y operadores</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-4' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-5" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-5' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">5. Declaraciones</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-5' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-6" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-6' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">6. Objetos</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-6' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-7" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-7' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">7. Arrays</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-7' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24">
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-8" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-8' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">8. Funciones</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-8' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" >
				...
				<li className="list-none">
					<a href="/javascript-la-guia-definitiva/capitulo-10" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-10' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
						<span className="ml-3 flex-1">10. Módulos</span>
						{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-10' ? 'fill-amber-900' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li className="list-none">
						<a href="/javascript-la-guia-definitiva/capitulo-17" className={`group flex items-center p-2 text-base rounded-sm font-normal transition-colors duration-500 text-amber-900 dark:text-[#FFF8E8] dark:hover:text-amber-900 hover:text-[#FFF8E8] dark:hover:bg-[#FFF8E8] hover:bg-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-17' ? 'dark:bg-[#FFF8E8] dark:text-amber-900' : ''}`}>
							<span className="ml-3 flex-1">17. Herramientas y extensiones de JavaScript</span>
							{isOpen ? <svg className={`fill-[#fff8e8] group-hover:fill-amber-900 ${direction === '/javascript-la-guia-definitiva/capitulo-17' ? 'fill-amber-900' : ''}`} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
